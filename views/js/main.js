...
var resizePizzas = function(size) { 
  ...
  // revised changePizzaSizes function with perfomance enhancements
    function changePizzaSizes(size) {
...
for (var i = 2; i < 100; i++) {
  //** moved this outside loop var pizzasDiv = document.getElementById("randomPizzas");
...
function updatePositions() {
  ...
  //** moved this calculation outside the loop
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  for (var i = 0; i < 40; i++) {
    ...
    //**  Moved the following outside the loop and converted it to getElementById
    //document.querySelector("#movingPizzas1").appendChild(elem);
    movingPizzas.appendChild(elem);
  }

  //** moved assignment of items to here and converted it to getElementsByClassName
